...
> Vynix PHP SDK: a client for the Vynix bug reporting and website feedback API.
...
Vynix PHP SDK is part of the [Vynix](https://vynix.in) developer toolkit. The feedback layer for teams that build with AI coding agents. This project helps you connect Vynix to your workflow so visual feedback and AI diagnosis reach your code faster.
...
Create a client with your project key and send feedback or read annotations from your PHP application.
